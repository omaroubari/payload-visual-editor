...
export const IconHelp = ({
  ...
  >
    ...
    <path
      ...
      strokeWidth="1.25"
    />
    <circle cx="10" cy="12.625" fill="currentColor" r="0.625" />
  </svg>
)
...
export const IconSendAnimated = ({
  ...
  <svg fill="none" height={size} viewBox="0 0 22 21" width={size}>
    ...
    <g className={`${s.iconState} ${sent ? s.hiddenScaled : s.visibleScaled}`}>
      ...
      <path
        ...
        strokeWidth="1.5"
      />
      <path d="M7.5 13.75H12.5" stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" />
      <path d="M7.5 10.75H10.5" stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" />
    </g>
...
export const IconEyeClosed = ({ size = 24 }: { size?: number }) => (
  <svg fill="none" height={size} viewBox="0 0 24 24" width={size}>
    <path
      ...
      fill="currentColor"
    />
    <path d="M5 19L19 5" stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" />
  </svg>
)
...
export const IconPausePlayAnimated = ({
  ...
  <svg fill="none" height={size} viewBox="0 0 24 24" width={size}>
    ...
    <g className={`${s.iconFadeFast} ${isPaused ? s.hidden : s.visible}`}>
      <path d="M8 6L8 18" stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" />
      <path d="M16 18L16 6" stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" />
    </g>
...
export const IconChatEllipsis = ({
  ...
  <svg fill="none" height={size} style={style} viewBox="0 0 24 24" width={size}>
    <path
      ...
      fill="currentColor"
    />
    <circle cx="15" cy="11.75" fill="currentColor" r="1" />
    <circle cx="12" cy="11.75" fill="currentColor" r="1" />
    <circle cx="9" cy="11.75" fill="currentColor" r="1" />
  </svg>
)
...
export const IconSquarePen = ({ size = 16 }: { size?: number }) => (
  <svg
    fill="none"
    height={size}
    stroke="currentColor"
...
export const AnimatedBunny = ({
  ...
  >
    ...
    <rect fill="transparent" height="28" width="28" />
    {/* Left ear */}
    <path
    ...
    />
    {/* Animated bunny eyes */}
    <circle className="bunny-eye-left" cx="8.277" cy="20.466" fill={color} r="1.8" />
    <circle className="bunny-eye-right" cx="19.878" cy="20.466" fill={color} r="1.8" />
    {/* Happy face on hover */}
    <text
...
export const IconLayout = ({ size = 24 }: { size?: number }) => (
  <svg fill="none" height={size} viewBox="0 0 24 24" width={size}>
    <rect height="18" rx="2" stroke="currentColor" strokeWidth="1.5" width="18" x="3" y="3" />
    <line stroke="currentColor" strokeWidth="1.5" x1="3" x2="21" y1="9" y2="9" />
    <line stroke="currentColor" strokeWidth="1.5" x1="9" x2="9" y1="9" y2="21" />
  </svg>
)
